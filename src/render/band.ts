...
export const BAND_STOPS: readonly BandStop[] = [
  {
    depth: 0,
    waterTop: [0.1, 0.22, 0.28],
    waterBottom: [0.04, 0.1, 0.15],
    ambient: 0.28,
    visibility: 2000,
    lightIntensity: 1.0,
    accent: [0.55, 0.85, 0.95],
    particleSize: 2.6,
    snowCount: 220,
    siltCount: 140,
    moteCount: 80,
    particleDrift: 26,
    currentDir: { x: 0.6, y: -0.25 },
    currentSpeed: 12,
    chromatic: 0.0012,
    grain: 0.05,
  },
  {
    depth: 1600,
    waterTop: [0.05, 0.12, 0.18],
    waterBottom: [0.02, 0.05, 0.1],
    ambient: 0.2,
    visibility: 800,
    lightIntensity: 1.0,
    accent: [0.45, 0.75, 0.9],
    particleSize: 2.2,
    snowCount: 180,
    siltCount: 180,
    moteCount: 110,
    particleDrift: 32,
    currentDir: { x: 0.7, y: -0.2 },
    currentSpeed: 20,
    chromatic: 0.0016,
    grain: 0.055,
  },
